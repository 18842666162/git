...
$(document).on('ready', function () {
	console.log("_____Tenney____________________ startup ____________________Tenney_____");
	// =================================================================================
	// jQuery UI Events
	// =================================================================================
	...
	//find chaincode again 再次找到chaincode
	...
	//register new marble owners  注册新大理石所有者
...
function show_start_up_step(obj) {
	...
	$('#showStartupPanel, #showSettingsPanel,#posi').prop('disabled', false);
}
